 ...
 * 
 ...
 I noticed acos, asin and atan (and atan2) were missing from the standard java mobile library. I wrote my own yesterday, I thought I'd post them as others may find them useful.

 Feel free to use them, obviously the code comes with no guarentees :)

 Note:
 I use 0.0/0.0 to generate nan value, this is dubious but the best I could think of :)
